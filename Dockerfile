FROM ubuntu:16.04
LABEL maintainer="Daniel Seither <daniel@kullo.net>"
LABEL description="Build environment for KulloChatServer, based on docker-swift"
...
ADD libsodium_0-1_amd64.deb .
RUN dpkg -i "libsodium_0-1_amd64.deb" && rm libsodium_0-1_amd64.deb
